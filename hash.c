 ...
 *      Keys are of type Coordinate.
 *      Values are of type Byte * (datacubes).
 *
 *      See hash.h for documentation of the functions.
 *
 */

// Having to include SDL headers here is a bit ugly. But we need them for
// knossos.h.
// We really have to find a nice way of solving this header-dependency mess.
...
uint32_t ht_union(Hashtable *target,
                  Hashtable *h1,
                  Hashtable *h2) {
