...
bool insideCurrentSupercube(const Coordinate & coord, const Coordinate & center, const Coordinate & cubesPerDimension, const Coordinate & cubeSizeGlobal) {
    ...
    const auto c = coord.cube(cubeSizeGlobal, {1.f,1.f,1.f});
    const auto tl = (center - halfSupercube).cube(cubeSizeGlobal, {1.f,1.f,1.f});
    const auto br = (center + halfSupercube).cube(cubeSizeGlobal, {1.f,1.f,1.f}) + 1;
    bool valid = true;
...
bool currentlyVisible(const Coordinate & coord, const Coordinate & center, const Coordinate & cubesPerDimension, const Coordinate & cubeSizeGlobal) {
    ...
    const auto c = coord.cube(cubeSizeGlobal, {1.f,1.f,1.f}).cube2Global(cubeSizeGlobal, {1.f,1.f,1.f});
