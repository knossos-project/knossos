...
private:
    ...
    std::vector<CoordOfCube> DcoiFromPos(const Coordinate &currentOrigin, const UserMoveType userMoveType, const floatCoordinate & direction, const Dataset & dataset);
    uint loadCubes();
