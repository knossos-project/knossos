...
docker commit $(docker container list -ql) ghcr.io/knossos-project/arch:multi
docker export $(docker container list -ql) | docker import - ghcr.io/knossos-project/arch
