...
public:
    ...
    inline CoordOfCube cube(const Coordinate & size, const floatCoordinate scale) const;
...
public:
    ...
    inline Coordinate insideCube2Global(const CoordOfCube & cube, const Coordinate & cubeEdgeLength, const floatCoordinate scale) const;
};
