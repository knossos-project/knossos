...
public slots:
    ...
    //patches
    static patchListElement *findPatchByPatchID(uint patchID);
    static bool delPatch(patchListElement *patchElToDel = NULL, uint patchID = 0);
    ...
    static bool clearAnnotation(int targetRevision, int loadingSkeleton);
