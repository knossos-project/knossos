...
public slots:
    ...
    treeListElement * addTreeListElement(boost::optional<decltype(treeListElement::treeID)> treeID, const boost::optional<decltype(treeListElement::color)> & color = boost::none);
