...
void checkIdleTime(){
    ...
    int hoursRunningTime = (int)(SDL_GetTicks()*0.001/3600.0);
    int minutesRunningTime = (int)(SDL_GetTicks()*0.001/60.0 - hoursRunningTime * 60);
    int secondsRunningTime = (int)(SDL_GetTicks()*0.001 - hoursRunningTime * 3600 - minutesRunningTime * 60);
    ...
    int hoursTracingTime = (int)((SDL_GetTicks() - state->skeletonState->idleTime)*0.001/3600.0);
    int minutesTracingTime = (int)((SDL_GetTicks() - state->skeletonState->idleTime)*0.001/60.0 - hoursTracingTime * 60);
    int secondsTracingTime = (int)((SDL_GetTicks() - state->skeletonState->idleTime)*0.001 - hoursTracingTime * 3600 - minutesTracingTime * 60);
