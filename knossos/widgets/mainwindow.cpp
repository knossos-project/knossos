...
//    this->toolBar->addWidget(toolsButton);
    ...
    skeletonModeRadio = new QRadioButton("Skeleton Mode");
    skeletonModeRadio->setToolTip("Enable skeleton annotation");
    skeletonModeRadio->setChecked(true);
    this->toolBar->addWidget(patchModeRadio);
    this->toolBar->addWidget(skeletonModeRadio);
    ...
    connect(patchModeRadio, SIGNAL(clicked()), this, SLOT(patchModeSelected()));
    connect(skeletonModeRadio, SIGNAL(clicked()), this, SLOT(skeletonModeSelected()));
...
void MainWindow::createMenus()
{
    ...
    editMenu->addAction(QIcon(":/images/icons/user-trash.png"), "Clear Annotation", this, SLOT(clearAnnotationSlot()));
...
void MainWindow::clearAnnotationWithoutConfirmation() {
    emit clearAnnotationSignal(CHANGE_MANUAL, false);
    updateTitlebar(false);
    emit updateToolsSignal();
    emit updateTreeviewSignal();
    emit updateCommentsTableSignal();
...
void MainWindow::clearAnnotationSlot()
{
    QMessageBox question;
    question.setWindowFlags(Qt::WindowStaysOnTopHint);
    question.setIcon(QMessageBox::Question);
    question.setWindowTitle("Confirmation required");
    question.setText("Really clear annotation (you cannot undo this)?");
