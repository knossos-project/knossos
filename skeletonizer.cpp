...
bool Skeletonizer::saveXmlSkeleton(QString fileName) {
    ...
    PTRSIZEUINT currentBranchPointID;
    ...
    while((currentBranchPointID = (PTRSIZEUINT)popStack(reverseBranchStack))) {
