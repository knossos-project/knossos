...
bool ToolsTreeviewTab::mergeTreesAction() {
    QMessageBox prompt;
...
void ToolsTreeviewTab::updateTreeColorCells(int row) {
...
void ToolsTreeviewTab::updateNodesTable() {
    ...
    if(actIDItem != NULL) {
        ...
        numNodes--; // for displaying number of listed nodes
    }
    ...
    emit updateListedNodesSignal(numNodes);
}
